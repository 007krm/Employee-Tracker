...
function viewEmployees() {
  let query =
    "SELECT employee.id, employee.first_name, employee.nickname, employee.last_name, department.dept_name, employee.salary, roles.title, mgr_name ";
  query += "FROM employee ";
...
function viewEmpsByDept() {
  let query =
    "SELECT department.dept_name, employee.id, employee.first_name, employee.nickname, employee.last_name ";
...
function viewEmpsByMgr() {
  ...
  let query =
    "SELECT manager.id, manager.mgr_name, employee.first_name, employee.nickname, employee.last_name ";
  query += "FROM manager ";
  ...
  inquirer
    .prompt([
      ...
      },
      {
        ...
        type: "input",
        message:
          "What is the new employee's nickname, if any? (Leave blank if none)",
      },
      {
        name: "newEmpLastName",
        type: "input",
...
function updateEmpRole() {
  let query =
    "SELECT employee.id, employee.first_name, employee.nickname, employee.last_name, department.dept_name, employee.roles_id, roles.title ";
  query += "FROM employee ";
  query += "INNER JOIN department ON employee.emp_dept = department.dept_name ";
  query += "INNER JOIN roles ON department.id = roles.department_id ";
...
function removeEmployee() {
  let query =
    "SELECT employee.id, employee.first_name, employee.nickname, employee.last_name ";
  query += "FROM employee ";
  connection.query(query, function (err, results) {
    if (err) throw err;
    inquirer
